...
Expression BiLSTM::run_KIM(DataSet& set, Embeddings& embedding, unsigned num_sentence, ComputationGraph& cg) 
{
	...
	compute_context_vector(cg, alpha_matrix, hypothesis_lstm_repr, hypothesis_lstm_repr.size(), premise_lstm_repr.size(), premise_c_vect);
	compute_context_vector(cg, beta_matrix, premise_lstm_repr, premise_lstm_repr.size(), hypothesis_lstm_repr.size(), hypothesis_c_vect);
