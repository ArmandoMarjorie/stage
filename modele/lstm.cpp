...
void LSTM::dev_score(ParameterCollection& model, Data& dev_set, Embeddings& embedding, string parameter_filename, unsigned nb_of_sentences_dev, double& best, char* output_emb_filename)
{
        double dev_loss = 0;
        double positive = 0;
        unsigned label_predicted;
        ...
        cerr << "Accuracy = " << (positive / (double) nb_of_sentences_dev) << endl;
