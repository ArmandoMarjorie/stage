...
Training: train.o rnn.o LSTM.o BILSTM.o data.o embedding.o detoken.o sw.o dataset.o bow.o
	$(CC) -o Training train.o rnn.o LSTM.o BILSTM.o data.o embedding.o detoken.o sw.o dataset.o bow.o $(LDFLAGS)

Testing: predict.o rnn.o LSTM.o BILSTM.o data.o embedding.o detoken.o sw.o dataset.o bow.o
	$(CC) -o Testing predict.o rnn.o LSTM.o BILSTM.o data.o embedding.o detoken.o sw.o dataset.o bow.o $(LDFLAGS)
...
rnn.o: modele/rnn.cpp modele/rnn.hpp code_data/dataset.hpp  tokenizer/detoken_explication.hpp
