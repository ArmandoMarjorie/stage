...
CFLAGS=-W -Wall -std=c++11 -pedantic -O3 -I/home/marjorie/Bureau/LIB/dynet -I/home/marjorie/Bureau/LIB/eigen `pkg-config --cflags gtkmm-3.0`
LDFLAGS=-L/home/marjorie/Bureau/LIB/dynet/build/dynet -ldynet `pkg-config --libs gtkmm-3.0`
...
data.o: code_data/data.cpp code_data/data.hpp code_data/embedding.hpp code_data/couple.hpp code_data/switch_words.hpp code_data/proba_bigram.hpp
