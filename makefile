...
Training: train.o lstm.o data.o bilstm.o
	$(CC) -o Training train.o lstm.o data.o bilstm.o $(LDFLAGS)
	
Testing: predict.o lstm.o data.o bilstm.o
	$(CC) -o Testing predict.o lstm.o data.o bilstm.o $(LDFLAGS)
