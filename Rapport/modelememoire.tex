...
\section{Introduction} % SECTION 1
	\subsection{Contexte et motivations}
		...
		Pour qu'un modèle soit digne de confiance, il faut que les explications fournies soient jugées correctes par les 
		utilisateurs.
...
\section{Etat de l'art} % SECTION 3
	\subsection{Dans la RTE}
		/*DECRIRE UNE APPROCHE COOL*/
	\subsection{Dans l'interprétabilité de prédictions de modèles}
		/*PARLER INTERPRETABILITE EN GENERAL ET PK CA S'APPLIQUE PAS AU TEXTE*/
		/*PARLER ARTICLE LREC*/
\begin{comment}
