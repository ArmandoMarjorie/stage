...
\section{Définition d'interprétabilité} % SECTION 4
...
\section{Systèmes implémentés} % SECTION 5
...
\section{Description de l'approche BAXI}
	...
	en donnant les $\alpha$ mots les plus importants dans la prémisse et les $\beta$ mots les plus importants dans l'hypothèse. On veut donc calculer l'importance de chaque mot. 
	...
	\\
	L'importance d'un mot, notée $IMP^{total}$ pour "importance", est une fonction comme suit : \\
...
\section{Cadre expérimental}
	\subsection{Corpus SNLI et représentation de mots} %FINI
		...
		composé de 19 paires prémisse/hypothèse avec leur étiquette associée. La table ci-dessous montre les taux des 
		...
		\begin{table}[h]
			...
			\hline
			\end{tabular}
			\caption{\bf{Taux des étiquettes présentes dans le corpus de l'échantillon de test.}}
			\end{center}
		\end{table}
...
\section{Résultats}
	Tout d'abord, les tables ci-dessous montrent les différents résultats des taux de réussite des étiquettes prédites avec les trois 
	systèmes décrits dans la section 5 : \\
	...
	La table ci-dessous montre les taux de réussite des étiquettes prédites pour les trois systèmes décrits en section <> 
	...
	\begin{table}[h]
		...
		\hline
		\end{tabular}
		\caption[Résultats des tests de la RTE pour le corpus de l'échantillon de test.]{\bf{Résultats des taux de réussite des étiquettes prédites pour le corpus de 
