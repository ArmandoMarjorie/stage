...
\section{Etat de l'art}
	...
	\subsection{Dans l'interprétabilité}
		...
		La figure ci-dessus est un exemple illustant le principe de LIME :
	...
	\subsection{Dans l'interprétabilité de la RTE}
		Ce n'est que très recemment que /*PARLER ARTICLE LREC*/
...
\section{Implémentation de systèmes}
	...
	\subsection{Données externes utilisées}
		Pour la RTE, nous utilisons les corpus SNLI composés d'un fichier d'entraînement, de validation et de test. 
		...
		la dite image. Les annotateurs devaient alors écrire une phrase étant neutre par rapport à la prémisse, une autre 
		étant en contradiction et une autre phrase qui pouvait être déduite de la prémisse : ils devaient donner une hypothèse 
		...
		le label de la paire observée. Ainsi, certaines paires n'ont pas de label car les annotateurs n'ont pas trouvé de 
