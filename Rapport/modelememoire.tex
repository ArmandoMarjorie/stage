...
\def\ResumeFrancais{
    ...
    Dans ce travail, nous proposons la méthode Best Adversario eXemple for Interpretability, qui respecte les règles d'une "bonne" explication 
    pour rendre un modèle interprétable dans le cadre de la RTE, avec l'utilisation du corpus SNLI \cite{ref}. Nous allons la comparer 
    ...
    de l'entrée. Pour cela, nous proposons de calculer la F-mesure de ces deux méthodes grâce à un corpus d'annotation de mots pertinents parmi un échantillon 
    du corpus de Test de SNLI.
    \\[2mm]
...
\section{Introduction}
	...
	\subsection{Problématique}
		...
		données. Nous verrons dans la section 3.2 quels sont les critères d'une "bonne" explication. De plus, si un système est 
...
\section{Réseaux de neurones récurrents}
	\subsection{Données externes utilisées}
		...
		\begin{table}[h]
			\center
			\includegraphics[width=11cm, height=10cm, keepaspectratio]{table_SNLI.png}
		...
		pas dans le vocabulaire de GloVe ont des embeddings initialisés au hasard. Plus de détails 
		sur les embeddings sont donnés en annexe.
	\begin{comment}
...
\section{Cadre expérimental}
	...
	\subsection{Mesure de la qualité de l'explication}
